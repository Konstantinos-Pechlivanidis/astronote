-- Add Queue, Session, and Rate Limit models (migrating legacy standalone SQL into Prisma migrations)
-- This migration is additive and uses IF NOT EXISTS to avoid impacting existing databases.
