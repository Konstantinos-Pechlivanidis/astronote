...
import { redactObject, redactHeaders } from './pii-redaction.js';
import { randomUUID } from 'crypto';

// Enhanced logger with structured logging and PII redaction
class Logger {
  constructor() {
  ...
  // Request logging (P1: with PII redaction)
  logRequest(req, res, responseTime) {
    // P1: Never log Authorization headers
    ...
    const meta = {
      ...
      // Headers already redacted (authorization removed)
