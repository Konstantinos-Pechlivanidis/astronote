        ...
        <div className="marketing-theme astro-shell min-h-screen flex flex-col text-text-primary">
          ...
          <header className="border-b border-white/10 bg-black/25 backdrop-blur-xl">
            <div className="max-w-6xl mx-auto px-4 py-5 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] uppercase tracking-[0.24em] text-text-tertiary">System status</p>
              </div>
            </div>
          </header>
          ...
          <main className="flex-1 flex items-center justify-center px-4 py-12">
            <div className="max-w-lg w-full rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-8 text-center shadow-[0_40px_120px_-80px_rgba(18,198,181,0.9)]">
              <p className="text-xs uppercase tracking-[0.3em] text-text-tertiary">Something went wrong</p>
              <h1 className="mt-3 text-3xl font-bold font-display">We hit a snag</h1>
              ...
              <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
                <button
                  type="button"
                  onClick={reset}
                  className="inline-flex items-center justify-center rounded-xl border border-white/20 bg-white/5 px-5 py-2.5 text-sm font-semibold text-text-primary hover:bg-white/10 transition"
                >
                  Try again
                </button>
                <Link
