...
const { getRedisClient, isRedisEnabled } = require('../../retail-api/src/lib/redis');
const { processBirthdayAutomations } = require('../../retail-api/src/services/automation.service');
