...
export default function ShopifyContactsPage() {
  ...
  if (isLoading) {
    return <LoadingBlock message="Loading Shopify contacts..." />;
  }

  if (error) {
    return (
      <ErrorState
        title="Failed to load Shopify contacts"
  ...
  return (
    <div>
      <PageHeader
        title="Shopify Contacts"
        description="Manage your Shopify contact list"
      ...
      <DataTable
        ...
        data={contacts}
        isLoading={isLoading}
        emptyTitle="No Shopify contacts found"
