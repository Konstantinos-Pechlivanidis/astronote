...
export default function ShopifyDashboardPage() {
  ...
  if (isLoading) {
    return <LoadingBlock message="Loading Shopify dashboard..." />;
  }

  if (error) {
    return (
      <ErrorState
        title="Failed to load Shopify dashboard"
  ...
  return (
    <div>
      <PageHeader title="Shopify Dashboard" description="Overview of your Shopify SMS marketing performance" />
      {/* KPI Cards */}
