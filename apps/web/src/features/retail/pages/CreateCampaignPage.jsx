...
import { useCreateRetailCampaign, useEnqueueRetailCampaign } from '../hooks/useRetailCampaigns';
import { useRetailSegments } from '../hooks/useRetailSegments';
...
export default function RetailCreateCampaignPage() {
  ...
  const createCampaign = useCreateRetailCampaign();
  const enqueueCampaign = useEnqueueRetailCampaign();
  const { data: segmentsData } = useRetailSegments();
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        <Button variant="ghost" size="icon" onClick={() => navigate('/retail/campaigns')}>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end gap-4">
          <Button type="button" variant="outline" onClick={() => navigate('/retail/campaigns')}>
            Cancel
          </Button>
          <Button
            type="button"
